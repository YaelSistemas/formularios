...
export default function SGI_POP_LG_01_FO_06_Checklist_de_Mantenimiento_Grua_Viajera({
  ...
  const renderMainSectionBox = (title, sections) => {
    return (
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            {renderMainSectionBox("CONDICIONES MECÁNICAS", condicionesMecanicasSections)}

            {renderMainSectionBox("CONDICIONES ELÉCTRICAS", condicionesElectricasSections)}

            {observacionesGenerales ? (
              <div style={nestedSectionStyle}>
                <div style={nestedSectionHeaderStyle}>Observaciones Generales</div>
            ...
            <div style={nestedSectionStyle}>
              <div style={nestedSectionHeaderStyle}>Responsable de Mantenimiento</div>
