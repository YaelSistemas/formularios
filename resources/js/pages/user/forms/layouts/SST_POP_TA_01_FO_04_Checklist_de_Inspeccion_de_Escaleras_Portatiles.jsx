...
export default function SST_POP_TA_01_FO_04_Checklist_de_Inspeccion_de_Escaleras_Portatiles({
  form,
  fields,
  answers,
  setVal,
  ...
  const tablaEscaleras = getField("tabla_escaleras_portatiles");
  ...
  const validateBeforeSubmit = () => {
    ...
    if (!tablaEscaleras) {
      setMsg("No se encontró la tabla de Escaleras Portátiles.");
      scrollToTopSafe();
      return false;
    }

    const rows = Array.isArray(answers[tablaEscaleras.id])
      ? answers[tablaEscaleras.id]
      : [];
    ...
    const rowSchema = Array.isArray(tablaEscaleras.row_schema)
      ? tablaEscaleras.row_schema
      : [];
          ...
          >
            ...
            <div style={{ padding: 16, display: "grid", gap: 14 }}>
              ...
              >
                ...
                >
                  <img
                    src={escalerasImagenTop}
                    alt="Inspección de Escalera Portátil"
                    style={{
                      display: "block",
                      width: "100%",
