...
export default function SST_POP_TA_05_FO_02_Inspeccion_de_Equipo_de_Oxicorte({
  form,
  fields,
  answers,
  setVal,
  ...
  const guiaInspeccion = getField("guia_inspeccion_text");
  const imagenOxicorte = getField("imagen_equipo_oxicorte");
  const indicacion1 = getField("indicaciones_line_1");
  const numeroIdentificacion = getField("numero_identificacion_equipo_oxicorte");
  const verificarJabonaduraText = getField("verificar_jabonadura_text");
  const observaciones = getField("observaciones");
  const notaFinal = getField("nota_final");

  const checklistItems = [
    {
      key: "carro_porta_cilindros_cadena",
      label: "1. Carro Porta Cilindros con Cadena",
      status: getField("carro_porta_cilindros_cadena_estado"),
    },
    {
      key: "estado_fisico_cilindros",
      label: "2. Estado Físico de los Cilindros",
      status: getField("estado_fisico_cilindros_estado"),
    },
    {
      key: "regulador_oxigeno",
      label: "3. Regulador de Oxígeno",
      status: getField("regulador_oxigeno_estado"),
    },
    {
      key: "manometro_alta_presion_oxigeno",
      label: "4. Manómetro de Alta Presión, Contenido",
      status: getField("manometro_alta_presion_oxigeno_estado"),
    },
    {
      key: "manometro_baja_presion_oxigeno",
      label: "5. Manómetro de Baja Presión, Trabajo",
      status: getField("manometro_baja_presion_oxigeno_estado"),
    },
    {
      key: "valvula_check_regulador_oxigeno",
      label: "6. Válvula Check Regulador de Oxígeno",
      status: getField("valvula_check_regulador_oxigeno_estado"),
    },
    {
      key: "regulador_acetileno",
      label: "7. Regulador de Acetileno",
      status: getField("regulador_acetileno_estado"),
    },
    {
      key: "manometro_alta_presion_acetileno",
      label: "8. Manómetro de Alta Presión, Contenido",
      status: getField("manometro_alta_presion_acetileno_estado"),
    },
    {
      key: "manometro_baja_presion_acetileno",
      label: "9. Manómetro de Baja Presión, Trabajo",
      status: getField("manometro_baja_presion_acetileno_estado"),
    },
    {
      key: "valvula_check_regulador_acetileno",
      label: "10. Válvula Check Regulador de Acetileno",
      status: getField("valvula_check_regulador_acetileno_estado"),
    },
    {
      key: "manguera_oxigeno",
      label: "11. Manguera de Oxígeno",
      status: getField("manguera_oxigeno_estado"),
    },
    {
      key: "valvula_check_maneral_oxigeno",
      label: "12. Válvula Check Maneral de Oxígeno",
      status: getField("valvula_check_maneral_oxigeno_estado"),
    },
    {
      key: "manguera_acetileno",
      label: "13. Manguera de Acetileno",
      status: getField("manguera_acetileno_estado"),
    },
    {
      key: "valvula_check_maneral_acetileno",
      label: "14. Válvula Check Maneral de Acetileno",
      status: getField("valvula_check_maneral_acetileno_estado"),
    },
    {
      key: "abrazaderas",
      label: "15. Abrazaderas",
      status: getField("abrazaderas_estado"),
    },
    {
      key: "maneral_mezclador_gases",
      label: "16. Maneral Mezclador de Gases",
      status: getField("maneral_mezclador_gases_estado"),
    },
    {
      key: "llave_dosificadora_oxigeno",
      label: "17. Llave Dosificadora de Oxígeno",
      status: getField("llave_dosificadora_oxigeno_estado"),
    },
    {
      key: "llave_dosificadora_acetileno",
      label: "18. Llave Dosificadora de Acetileno",
      status: getField("llave_dosificadora_acetileno_estado"),
    },
    {
      key: "boquilla_corte_soldadura",
      label: "19. Boquilla de Corte o Soldadura",
      status: getField("boquilla_corte_soldadura_estado"),
    },
    {
      key: "tuercas_roscadas_union_empaques",
      label: "20. Tuercas Roscadas de Unión y Empaques",
      status: getField("tuercas_roscadas_union_empaques_estado"),
    },
    {
      key: "limpia_boquillas",
      label: "21. Limpia Boquillas",
      status: getField("limpia_boquillas_estado"),
    },
    {
      key: "chispero",
      label: "22. Chispero",
      status: getField("chispero_estado"),
    },
    {
      key: "llave_cuadro_acetileno",
      label: "23. Llave de Cuadro de Acetileno",
      status: getField("llave_cuadro_acetileno_estado"),
    },
    {
      key: "extintor_cercano_area_trabajo",
      label: "24. Extintor Cercano al Área de Trabajo",
      status: getField("extintor_cercano_area_trabajo_estado"),
    },
  ];
  ...
  const renderInnerField = (f, labelText) => {
    if (!f) return null;
  ...
  const validateBeforeSubmit = () => {
    ...
    if (
      !validateSimpleRequiredField(
        ...
        "Debes capturar el Número de Identificación de Equipo de Oxicorte."
      )
    ) {
      return false;
    }
