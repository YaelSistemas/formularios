...
export default function SST_POP_TA_01_FO_07_Checklist_de_Tecle({
  form,
  fields,
  answers,
  setVal,
  ...
  const tablaTecle = getField("tabla_tecle");
  ...
  const tecleImagenTop =
  "/images/forms/SST_POP_TA_01_FO_07_Checklist_de_Tecle/Tecle.png";

  const getTecleDescription = (id) => {
    const descriptions = {
      tecle_1_estado:
      ...
      tecle_11_estado:
        "Se atora, no cambia de dirección, falta el tornillo del selector",
  
      tecle_12_estado:
        "Roto, torcido o quebrado",
    };
  ...
  const validateBeforeSubmit = () => {
    ...
    const rows = Array.isArray(answers[tablaTecle.id])
      ? answers[tablaTecle.id]
      : [];
    ...
    const rowSchema = Array.isArray(tablaTecle.row_schema)
      ? tablaTecle.row_schema
      : [];
                          ...
                          {group.fields.map((col) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                {(col.description || getTecleDescription(col.id)) ? (
                                  <div
                                    style={{
                                      marginTop: 8,
                                      marginBottom: 10,
