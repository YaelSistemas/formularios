...
export default function SGI_POP_LG_01_FO_03_Checklist_Semanal_Montacargas({
  form,
  fields,
  answers,
  setVal,
  ...
  const [condicionEquipoOpen, setCondicionEquipoOpen] = useState(true);
  const [sistemaSeguridadOpen, setSistemaSeguridadOpen] = useState(true);
  const [sistemaRefrigeracionOpen, setSistemaRefrigeracionOpen] = useState(true);
  ...
  const isMainTitle = (f) => {
    ...
    return (
      ...
      text === "CONDICION DEL EQUIPO" ||
      text === "SISTEMA DE SEGURIDAD" ||
      text === "SISTEMA DE REFRIGERACIÓN" ||
      text === "SISTEMA DE REFRIGERACION"
    );
  };
  ...
  const equipo = getField("equipo");
  const horometro = getField("horometro");
  const fechaUltimoMantenimiento = getField("fecha_ultimo_mantenimiento");
  ...
  const condicionEquipoSections = [
    {
      title: "LLANTAS (REVESTIMIENTO Y PRESION)",
      criteria: [
        {
          baseId: "condicion_equipo_llantas",
          title: "No presenta fisuras, grietas, cortaduras, chipotes, ni desgaste excesivo",
        },
      ],
    },
    {
      ...
      criteria: [
        {
          baseId: "condicion_equipo_carroceria",
          title:
            "Libre de golpes, fisuras o corrosión. No tiene partes sueltas ni deformaciones que afecten la estructura",
        },
      ],
    },
    {
      ...
      criteria: [
        {
          baseId: "condicion_equipo_volante",
          title: "Gira correctamente sin dificultad. No presenta daños visibles",
        },
      ],
    },
    {
      ...
      criteria: [
        {
          baseId: "condicion_equipo_asiento",
          title:
            "En buen estado, sin roturas ni desgaste excesivo. Ajuste funcional y cinturón de seguridad operativo.",
        },
      ],
    },
    {
      title: "RELOJES INDICADORES",
      criteria: [
        {
          baseId: "condicion_equipo_relojes_indicadores",
          title:
            "Todos los indicadores funcionan correctamente (combustible, temperatura, presión de aceite, horómetro, etc.)",
        },
      ],
    },
    {
      ...
      criteria: [
        {
          baseId: "condicion_equipo_freno",
          title:
            "Responde de manera efectiva al aplicar presión. Sin ruidos extraños ni recorrido excesivo del pedal.",
        },
      ],
    },
    {
      ...
      criteria: [
        {
          baseId: "condicion_equipo_freno_emergencia",
          title: "Se activa correctamente y mantiene el montacargas fijo.",
        },
      ],
    },
    {
      title: "CARRO PORTAHORQUILLAS",
      criteria: [
        {
          baseId: "condicion_equipo_carro_portahorquillas",
          title: "Sin deformaciones ni daños estructurales. Movimiento fluido y seguro.",
        },
      ],
    },
    {
      title: "INCLINACION DE HORQUILLAS",
      criteria: [
        {
          baseId: "condicion_equipo_inclinacion_horquillas",
          title: "Se inclina sin obstrucciones ni movimientos bruscos.",
        },
      ],
    },
    {
      title: "SUBIR Y BAJAR HORQUILLAS",
      criteria: [
        {
          baseId: "condicion_equipo_subir_bajar_horquillas",
          title: "Movimiento fluido y sin bloques.",
        },
      ],
    },
    {
      title: "ESTADO Y SEGURO DE HORQUILLAS",
      criteria: [
        {
          baseId: "condicion_equipo_estado_seguro_horquillas",
          title: "No presenta fisuras, grietas, cortaduras, chipotes, ni desgaste excesivo.",
        },
      ],
    },
    {
      title: "ETIQUETA DE CARGA MÁXIMA",
      criteria: [
        {
          baseId: "condicion_equipo_etiqueta_carga_maxima",
          title: "Visible y en buenas condiciones. No esta borrosa ni deteriorada.",
        },
      ],
    },
    {
      title: "SEÑALAMIENTO EN PALANCAS",
      criteria: [
        {
          baseId: "condicion_equipo_senalamiento_palancas",
          title: "No estas desgastadas.",
        },
      ],
    },
    {
      title: "ETIQUETA DE TIPO COMBUSTIBLE",
      criteria: [
        {
          baseId: "condicion_equipo_etiqueta_tipo_combustible",
          title: "Visible y en buen estado.",
        },
      ],
    },
    {
      title: "MANUAL DE PROCEDIMIENTO",
      criteria: [
        {
          baseId: "condicion_equipo_manual_procedimiento",
          title: "Disponible en la unidad.",
        },
      ],
    },
  ];

  const sistemaSeguridadSections = [
    {
      title: "TORRETA",
      criteria: [
        { baseId: "sistema_seguridad_torreta", title: "Funciona correctamente." },
      ],
    },
    {
      title: "ESPEJOS",
      criteria: [
        {
          baseId: "sistema_seguridad_espejos",
          title: "No están rotos ni sucios. Proporcionan una visión clara del entorno.",
        },
      ],
    },
    {
      ...
      criteria: [
        {
          baseId: "sistema_seguridad_claxon",
          title: "Funciona adecuadamente y titne una buena potencia sonora.",
        },
      ],
    },
    {
      ...
      criteria: [
        {
          baseId: "sistema_seguridad_cinturon_seguridad",
          title: "Buen estado de las correas y seguros, se ajusta correctamente.",
        },
      ],
    },
    {
      ...
      criteria: [
        {
          baseId: "sistema_seguridad_extintor",
          title: "Presión adecuada, sin caducar y en sitio correcto.",
        },
      ],
    },
    {
      title: "ALARAMA DE REVERSA",
      criteria: [
        {
          baseId: "sistema_seguridad_alarma_reversa",
          title: "Emite un sonido fuerte y claro al retroceder.",
        },
      ],
    },
    {
      ...
      criteria: [
        {
          baseId: "sistema_seguridad_faros_delanteros",
          title: "Funciona correctamente y brindan iluminación adecuada.",
        },
      ],
    },
    {
      title: "FAROS Y CUARTOS TRASEROS",
      criteria: [
        {
          baseId: "sistema_seguridad_faros_cuartos_traseros",
          title: "Funcionan correctamente y están libres de daños.",
        },
      ],
    },
    {
      ...
      criteria: [
        {
          baseId: "sistema_seguridad_cadena",
          title: "en buen estado, sin desgaste excesivo ni oxidación.",
        },
      ],
    },
    {
      title: "ETIQUETA DE PUNTO DE IZAJE, INDICADOR DE VELOCIDAD MÁXIMA",
      criteria: [
        {
          baseId: "sistema_seguridad_etiquetas_izaje_velocidad",
          title: "Las etiquetas estan en buen estado y son legibles.",
        },
      ],
    },
  ];

  const sistemaRefrigeracionSections = [
    {
      title: "ANTICONGELANTE",
      criteria: [
        { baseId: "sistema_refrigeracion_anticongelante", title: "Nivel adecuado y sin fugas." },
      ],
    },
    {
      title: "SISTEMA HIDRAULICO (PISTÓN/MANGUERAS)",
      criteria: [
        {
          baseId: "sistema_refrigeracion_sistema_hidraulico",
          title:
            "Sin fugas ni daños visibles en pistón o mangueras. Revisión de conexiones y limpieza.",
        },
      ],
    },
    {
      title: "ACEITE DE TRANSMISIÓN AUTOMATICA",
      criteria: [
        {
          baseId: "sistema_refrigeracion_aceite_transmision_automatica",
          title: "Nivel adecuado y sin fugas. No presenta olores extraños.",
        },
      ],
    },
    {
      ...
      criteria: [
        {
          baseId: "sistema_refrigeracion_aceite_motor",
          title: "Nivel adecuado y sin fugas. Sin presencia de residuos o contaminación.",
        },
      ],
    },
    {
      title: "FUGAS DE ACEITE/FLUIDO/COMBUSTIBLE/AGUA",
      criteria: [
        {
          baseId: "sistema_refrigeracion_fugas",
          title: "No se detectan fugas en el sistema.",
        },
      ],
    },
    {
      ...
      criteria: [
        {
          baseId: "sistema_refrigeracion_mangueras",
          title: "Sin rayones, golpes, grietas ni fugas. Conexiones firmes y en buen estado.",
        },
      ],
    },
    {
      title: "TAPÓN DE COMBUSTIBLES",
      criteria: [
        {
          baseId: "sistema_refrigeracion_tapon_combustibles",
          title:
  ...
  const openSectionForField = (fieldId) => {
    ...
    if (
      ...
      id.startsWith("condicion_equipo_") ||
      id.startsWith("sistema_seguridad_") ||
      id.startsWith("sistema_refrigeracion_")
    ) {
      setIndicacionesOpen(true);
    }

    if (id.startsWith("condicion_equipo_")) {
      setCondicionEquipoOpen(true);
    }

    if (id.startsWith("sistema_seguridad_")) {
      setSistemaSeguridadOpen(true);
    }

    if (id.startsWith("sistema_refrigeracion_")) {
      setSistemaRefrigeracionOpen(true);
    }
  };
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            {nombreInspector ? renderOuterField(nombreInspector) : null}

            {nombreInspector && firmaInspector ? renderDivider("nombre_inspector_divider") : null}

            {firmaInspector ? renderOuterField(firmaInspector) : null}
            ...
            >
              ...
              {indicacionesOpen ? (
                ...
                >
                  ...
                  {renderDivider("texto_imagen_divider")}
                  ...
                  >
                    <img
                      src="/images/forms/SGI_POP_LG_01_FO_03_Checklist_Semanal_Montacargas/Montacargas.jpg"
                      alt="Montacargas"
                      style={{
                        maxWidth: "100%",
                  ...
                  {renderDivider("imagen_montacargas_divider")}

                  {equipo ? renderOuterField(equipo) : null}
                  {equipo ? renderDivider("equipo_divider") : null}

                  {horometro ? renderOuterField(horometro) : null}
                  {horometro ? renderDivider("horometro_divider") : null}

                  {fechaUltimoMantenimiento ? renderOuterField(fechaUltimoMantenimiento) : null}
                  {fechaUltimoMantenimiento ? renderDivider("fecha_ultimo_mantenimiento_divider") : null}

                  {renderMainSectionBox(
                    "CONDICIÓN DEL EQUIPO",
                    condicionEquipoSections,
                    condicionEquipoOpen,
                    setCondicionEquipoOpen
                  )}

                  {renderMainSectionBox(
                    "SISTEMA DE SEGURIDAD",
                    sistemaSeguridadSections,
                    sistemaSeguridadOpen,
                    setSistemaSeguridadOpen
                  )}

                  {renderMainSectionBox(
                    "SISTEMA DE REFRIGERACIÓN",
                    sistemaRefrigeracionSections,
                    sistemaRefrigeracionOpen,
                    setSistemaRefrigeracionOpen
                  )}
                </div>
              ) : null}
            </div>
            ...
            {notas ? (
              <div>
                {renderOuterField({ ...notas, label: "Notas" })}
              </div>
            ) : null}
          </div>
