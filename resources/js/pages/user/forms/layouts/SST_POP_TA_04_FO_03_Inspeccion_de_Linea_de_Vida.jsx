...
export default function SST_POP_TA_04_FO_03_Inspeccion_de_Linea_de_Vida({
  form,
  fields,
  answers,
  setVal,
  ...
  const openTableModal = (field) => {
    ...
    setModalCollapsedSections(buildInitialModalCollapsedSections(field, false));
  ...
  const buildModalGroups = (rowSchema) => {
    ...
    rowSchema.forEach((col) => {
      ...
      const belongsToSection =
        ...
        id.startsWith("amortiguador_") ||
        id.startsWith("ganchos_") ||
  ...
  const buildInitialModalCollapsedSections = (field, collapsed = false) => {
  ...
  const tablaLineaVida = getField("tabla_linea_vida");

  const lineaVidaImagenTop =
  "/images/forms/SST_POP_TA_04_FO_03_Inspeccion_de_Linea_de_Vida/InspeccLineaVida.png";
  ...
  const validateBeforeSubmit = () => {
    ...
    if (!tablaLineaVida) {
      setMsg("No se encontró la tabla de línea de vida.");
      scrollToTopSafe();
      return false;
    }
