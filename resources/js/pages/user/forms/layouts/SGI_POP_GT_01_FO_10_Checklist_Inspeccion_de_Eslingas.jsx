...
export default function SGI_POP_GT_01_FO_10_Checklist_Inspeccion_de_Eslingas({
  form,
  fields,
  answers,
  setVal,
  ...
  const nombreColaboradorInspecciona = getField("nombre_colaborador_inspecciona");
  const firmaColaboradorInspecciona = getField("firma_colaborador_inspecciona");
  const indicacionesToggle = getField("indicaciones_toggle");
  const indicacion1 = getField("indicacion_1");
  const tablaEslingas = getField("tabla_eslingas");
  ...
  const validateBeforeSubmit = () => {
    ...
    if (!rows.length) {
      setMsg("Debes agregar al menos una fila en la tabla de inspección de eslingas.");
      scrollToTopSafe();
      return false;
    }
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            {renderOuterRequiredField(nombreColaboradorInspecciona)}
            ...
            {renderOuterRequiredField(firmaColaboradorInspecciona)}
